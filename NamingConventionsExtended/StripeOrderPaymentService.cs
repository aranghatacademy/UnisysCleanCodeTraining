...
namespace Aranghat.Product.Feature
{
    ...
    public class StripeOrderPaymentService : IOrderPaymentService
    {
        ...
        public string InitiateOrderPayment(OrderPaymentRequest orderPaymentRequest)
        {
            throw new NotImplementedException();
        }

        public bool IsOrderPaymentCompleted(int orderId)
        {
            throw new NotImplementedException();
        }
        ...
        #region Constructors
        public StripeOrderPaymentService(int id, string name)
        {
            this.id = id;
            Name = name;
        }
